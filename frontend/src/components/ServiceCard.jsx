...
<div className='flex justify-end'>
  ...
  className={`mt-2 py-2 px-3 cursor-pointer rounded-4xl font-medium text-white transition-all duration-300 flex items-center justify-center group/btn text-xs sm:text-sm ${
    isHovered ? 'bg-[#6B4E71]' : 'bg-[#6B4E71]'
  }`}
>
  Book Now
</button>
