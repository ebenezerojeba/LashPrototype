          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#6B4E71]"
                required
              >
    ...
    />
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
          <button
            ...
            disabled={loading}
            className="bg-[#6B4E71] text-white px-4 py-2 rounded-md hover:bg-[#6B4E71] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
                ...
                <tr className="bg-gray-50">
                  <td className="px-3 md:px-6 py-4 whitespace-nowrap">
                    ...
                    <button
                      ...
                      className="flex items-center font-medium hover:text-[#6B4E71] focus:outline-none focus:text-[#6B4E71] text-left"
                  ...
                  <td className="px-3 md:px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex gap-1 md:gap-2">
                      <button
                        ...
                        className="text-[#6B4E71] hover:text-blue-900 p-1"
  ...
  if (loading && Object.keys(services).length === 0) {
    return (
      <div className="flex justify-center items-center py-12">
        <Loader2 className="w-8 h-8 animate-spin text-[#6B4E71]" />
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            className="bg-[#6B4E71] text-white px-4 py-2 rounded-md flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors"
          >
            <Plus className="w-4 h-4" />
            Add Service
          </button>
