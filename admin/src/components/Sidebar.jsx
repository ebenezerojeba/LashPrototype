...
const Sidebar = ({ onLogout, notifications = 0, className = '' }) => {
  ...
  const NavItem = ({ item }) => (
    <NavLink
      ...
      className={({ isActive }) =>
        ...
        ${isActive
          ? 'bg-blue-50 text-[#6B4E71] ring-1 ring-blue-100'
  ...
  const SidebarContent = () => (
    <>
      <div className="flex items-center justify-between p-4 bg-[#6B4E71] text-white">
        <div
        ...
        >
          ...
          {isExpanded && (
            <div>
              <div className="font-bold text-lg">Beautish_NG</div>
